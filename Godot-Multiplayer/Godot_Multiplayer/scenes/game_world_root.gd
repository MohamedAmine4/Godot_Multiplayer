...
var client_time
@rpc("authority") func send_time(client_time):
	self.client_time = client_time
	send_server_time.rpc(client_time, Time.get_unix_time_from_system())
	pass
...
func upnp_setup():
	...
	####################################
# Ces signaux sont émis lorsque des pairs (clients) se connectent ou se déconnectent du serveur.
