...
func _enter_tree():
	...
	#Les lignes suivantes connectent les signaux de l'interface utilisateur du chat à des fonctions qui gèrent le gel et le dégel des commandes du personnage.
